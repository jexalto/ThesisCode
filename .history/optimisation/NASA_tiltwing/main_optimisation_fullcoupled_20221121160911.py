...
# prob.run_driver()
prob.check_partials(compact_print=True, show_only_incorrect=True, includes=['EOAS.geometry.mesh.propeller'], form='central', step=1e-6) # excludes=['*parameters*, *helix*, *EOAS*, *rethorst*']

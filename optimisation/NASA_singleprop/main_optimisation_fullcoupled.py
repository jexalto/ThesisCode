...
class master(om.Group):
    ...
    def setup(self):
        ...
        self.connect('helix0.rotorcomp_0_velocity_distribution',        'helix_coupler.vel_distr_1')
        self.connect('helix0.rotorcomp_0_radii',                        'helix_coupler.radii_0')
        self.connect('helix0.rotorcomp_0_radii',                        'helix_coupler.radii_1')
        ...
        self.connect('helix0.rotorcomp_0_power',                         'obj_function.power1')

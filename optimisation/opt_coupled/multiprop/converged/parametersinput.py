...
class parameters(om.IndepVarComp):
    ...
    def setup(self):
        ...
        self.add_output('radius', val=0.1185, units='m') #0.14391204 # 0.1185
        ...
        chord_cp = np.ones(spanwisesections)*1 #[0.01      , 0.05257288, 0.10513638, 0.21928196] #ones(spanwisesections)*0.24
...
# [0.01      , 0.05257288, 0.10513638, 0.21928196] #ones(spanwisesections)*0.24
#         twist_cp = [10.        , 10.        , 10.        ,  8.99935772
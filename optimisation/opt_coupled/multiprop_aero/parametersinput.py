...
class parameters(om.IndepVarComp):
    ...
    def setup(self):
        ...
        self.add_output("W0", val=12, units="kg") # converged correct, 12, 23
        ...
        twist_cp = np.ones(spanwisesections) # [10.        , 10.        , 10.        ,  8.99935772] #zeros(spanwisesections)

...
class master(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('EOAS', subsys=EOAS(panels_chord_VLM=nx-1, panels_span_VLM=ny-1, span_0=span_max-0.02, radii_shape=N_elem_span+1))
    ...
    def configure(self):
        ...
        self.add_design_var('parameters.twist',                     lower=-5, upper=5, scaler=10.)
...
prob.run_driver()
# prob.check_partials(compact_print=True, show_only_incorrect=False, includes=['*EOAS.wing.geometry.mesh.propeller*'], form='central', step=1e-8) # excludes=['*parameters*, *helix*, *EOAS*, *rethorst*']

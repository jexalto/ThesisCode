...
def load_config(matfile, viscous=False,skinfriction=True, iter_max=1):
    ...
    #from Q.get_f import Get_f # only needed if full blade polar required see line 88
...
if __name__ == '__main__':
    res = main('Temp/Temp_design.mat', 3, viscous=False, skinf=False, props=[], iter_max=1)

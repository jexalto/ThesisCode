...
def correction_(panels_VLM, span, jet_loc, jet_radius, Vinf, Vjet, span_max, r_min, panels_overset_wing, panels_jet):
    ...
    overset_nointerpolation(span, 1., jet_loc, jet_radius, Vinf, Vjet, panels_jet,\
        panels_overset_wing, nx, panels_VLM, span_max, r_min, correction_matrix, mesh, G_, discr_interp, y_VLM)
    ...
    return correction_matrix, panels_jet, panels_overset_wing, G_, discr_interp, y_VLM, delta_wing, delta_jet
